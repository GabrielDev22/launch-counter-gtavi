...
export class GtaCharacterComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.metaService.updateTag({
      name: 'description',
      content: 'Conoce a Lucia y Jason, los dos protagonistas jugables de GTA VI. La primera mujer protagonista de la saga y su compañero criminal en el estado de Leonida.'
    });
